    ...
    .then(function (respuesta) {
        ...
        for (let i = 0; i < 5; i++) {
            ...
            listaLatest.innerHTML += `<article class="item">
                                  <a href="./detail-movie.html?q=${latest.id}"> <img class="imagenes" src="https://image.tmdb.org/t/p/w500/${latest.poster_path}" alt=""></a>
                                  <a href="./detail-movie.html?q=${latest.id}"><h3>${latest.title}</h3></a>
                                  <a href="./detail-movie.html?q=${latest.id}"><p>${latest.release_date}</p></a>
                                  <a href="./detail-movie.html?q=${latest.id}" class="ver_mas">Ver mas</a>
                                  </article>`
        }
    ...
    .then(function (respuesta) {
        ...
        for (let i = 0; i < 5; i++) {
            ...
            listaSeries.innerHTML += `<article class="item">
                                  ...
                                  <a href="./detail-movie.html?q=${series.id}" class="ver_mas">Ver mas</a>
                                  </article>`
        }
